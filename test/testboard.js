...
describe("Board", function() {
  ...
  describe("check diag lower left", function() {
    ...
    it("should check rows and return match", function() {
      ...
      placeCheckDiagLowerLeftIndexes(board, 7, 5, "X", false);                

      placeCheckDiagLowerLeftIndexes(board, 10, 6, "X", false);
      placeCheckDiagLowerLeftIndexes(board, 9, 6, "O", false);
      placeCheckDiagLowerLeftIndexes(board, 8, 6, "X", false);    

      placeCheckDiagLowerLeftIndexes(board, 10, 7, "O", false);
      placeCheckDiagLowerLeftIndexes(board, 9, 7, "X", false);    

      placeCheckDiagLowerLeftIndexes(board, 10, 8, "X", true);
